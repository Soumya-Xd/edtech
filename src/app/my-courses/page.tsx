...
export default function MyCoursesPage() {
  ...
  const { data, loading, error } = useQuery(GET_USER_ENROLLMENTS, {
            ...
            {[...data.getUserEnrollments]
              ...
              .map((enrollment: any) => (
                <Link key={enrollment.id} href={`/course/${enrollment.course.id}`}>
                  <div className="p-5 border border-gray-200 rounded-lg shadow-md hover:shadow-xl hover:bg-white transition duration-200 cursor-pointer bg-white">
